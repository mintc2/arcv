...
const config: SiteConfig = {
  ...
  tags: ['Software', 'Software development', 'Privacy', 'Cybersecurity'],
  ...
  socialLinks: {
    github: 'https://github.com/mintc2',
    email: 'mintc2@proton.me',
    // twitter: '',
    // mastodon: '',
    // linkedin: '',
    // bluesky: '',
